...
const { COMPOSITE, DECORATOR } = require('../constants.js');
const Decorators = require('./../decorators/index.js');
const Composites = require('./../composites/index.js');
const Actions = require('./../actions/index.js');
const Customs = require('./../custom/index.js')
...
class BehaviorTree {
    ...
    load(data, names) {
        ...
        for (id in data.nodes) {
            ...
            } else if (spec.name in Customs) {
                Cls = Customs[spec.name];
            } else {
                // Invalid node name
    ...
    tick(target, blackboard) {
        if (!blackboard) {
            throw new Error('The blackboard param is obligatory and must be ' +
                'an instance of b3.Blackboard');
        }
